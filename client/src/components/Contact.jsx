...
const Contact = ({userId, username, email, selected, onClick, online}) => {
  return (
    <div
      onClick={onClick}
      className={
        "transition-all duration-300 hover:bg-bg_primary_dark hover:rounded-lg " +
        " cursor-pointer " +
    ...
    >
      ...
      <div className="flex xs:gap-1 md:gap-2 xs:h-8 md:h-14 xs:pl-2 lg:pl-4 items-center capitalize xs:text-[0.5rem] sm:text-xs md:text-base xs:-mx-1 md:mx-0">
        ...
        <div className="flex flex-col">
          ...
          {email && (
            <div className="flex items-center flex-wrap  sm:-mt-1 md:mt-0">
